...
namespace RepositoryPattern.WebApi.Dapper.Contracts
{
    public class CompanyRepository : ICompanyRepository
    {
        ...
        {
            var query = "SELECT * FROM [dbo].[Company] WHERE Id = @Id";
        ...
        {
            var query = "UPDATE [dbo].[Company] SET Name = @Name, Address = @Address, Country = @Country WHERE Id = @Id";
        ...
        {
            var procedureName = "[dbo].[ShowCompanyForProvidedEmployeeId]";
            var parameters = new DynamicParameters();
        ...
        {
            var query = "SELECT * FROM [dbo].[Company] c JOIN [dbo].[Employee] e ON c.Id = e.CompanyId";
